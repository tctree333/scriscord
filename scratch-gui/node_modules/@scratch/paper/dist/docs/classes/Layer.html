...
<p>The Layer item represents a layer in a Paper.js project.</p>
<p>The layer which is currently active can be accessed through <a href="../classes/Project.html#activelayer"><tt>project.activeLayer</tt></a>. An array of all layers in a project can be accessed through <a href="../classes/Project.html#layers"><tt>project.layers</tt></a>.</p>
...
<a name="layer" href="#layer"><tt><b>Layer</b>([children])</tt></a>
</div>
<div class="member-description hidden">
<div class="member-text">
    <p>Creates a new Layer item and places it at the end of the <a href="../classes/Project.html#layers"><tt>project.layers</tt></a> array. The newly created layer will be activated, so all newly created items will be placed within it.</p>
...
&mdash;&nbsp;An array of items that will be added to the newly created layer
&mdash;&nbsp;optional
</li>
...
<pre><code>var layer = new Layer();</code></pre>
...
<div id="layer-object" class="member">
<div class="member-link">
<a name="layer-object" href="#layer-object"><tt><b>Layer</b>(object)</tt></a>
</div>
<div class="member-description hidden">
<div class="member-text">
    <p>Creates a new Layer item and places it at the end of the <a href="../classes/Project.html#layers"><tt>project.layers</tt></a> array. The newly created layer will be activated, so all newly created items will be placed within it.</p>
...
<tt>object:</tt> 
<tt>Object</tt>
&mdash;&nbsp;an object containing the properties to be set on  the layer
...
<pre><code>var firstLayer = project.activeLayer;
var secondLayer = new Layer();
console.log(project.activeLayer == secondLayer); // true
firstLayer.activate();
console.log(project.activeLayer == firstLayer); // true</code></pre>
