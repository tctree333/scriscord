...
<div class="member-text">
    <p>Creates a new raster item from the passed argument, and places it in the active layer. <code>object</code> can either be a DOM Image, a Canvas, or a string describing the URL to load the image from, or the ID of a DOM element to get the image from (either a DOM Image or a Canvas).</p>
...
<div id="context-modify" class="member">
<div class="member-link">
<a name="context-modify" href="#context-modify"><tt><b>context</b></tt></a>
</div>
<div class="member-description hidden">
...
<div class="canvas"><canvas width="516" height="200" id="canvas-22"></canvas></div>
</div>
...
<div class="canvas"><canvas width="516" height="120" id="canvas-23"></canvas></div>
</div>
...
<div class="canvas"><canvas width="516" height="240" id="canvas-30"></canvas></div>
</div>
