...
export default {
  ...
  "ar": {
    ...
    "paint.modeTools.pointed": "يشير الى",
  ...
  "az": {
    ...
    "paint.paintEditor.redo": "Yenidən ",
    ...
    "paint.eraserMode.eraser": "Pozan",
    "paint.fillMode.fill": "Rənglə doldur",
    "paint.lineMode.line": "Xətt",
    "paint.ovalMode.oval": "Dairə",
    "paint.rectMode.rect": "Düzbucaqlı",
    "paint.reshapeMode.reshape": "Formaya düzəliş et",
    "paint.roundedRectMode.roundedRect": "Yuvarlaq Düzbucaqlı",
    "paint.selectMode.select": "Seç",
    "paint.textMode.text": "Mətn",
  ...
  "et": {
    ...
    "paint.paintEditor.saturation": "Küllastust",
    "paint.paintEditor.brightness": "Valgustatus",
    ...
    "paint.paintEditor.fill": "Täitevärv",
    "paint.paintEditor.costume": "Kostüüm",
    "paint.paintEditor.group": "Grupp",
    "paint.paintEditor.ungroup": "Lahtigrupeerimine",
    "paint.paintEditor.undo": "Võta tagasi",
    "paint.paintEditor.redo": "Tee uuesti",
    "paint.paintEditor.forward": "Too ettepoole",
    "paint.paintEditor.backward": "Saada tagasi",
    "paint.paintEditor.front": "Too esiplaanile",
    "paint.paintEditor.back": "Tagasi",
  ...
  "el": {
    ...
    "paint.paintEditor.vector": "Μετατροπή σε Διάνυσμα",
    ...
    "paint.reshapeMode.reshape": "Αλλαγή του σχήματος",
  ...
  "it": {
    ...
    "paint.reshapeMode.reshape": "Cambia Forma",
  ...
  "lv": {
    ...
    "gui.comingSoon.message1": "Neuztraucies, mēs strādājam {emoji}",
    "gui.comingSoon.message2": "Turpinājumā...",
    "gui.comingSoon.message3": "Mēs vēl strādājam {emoji}",
    "paint.paintEditor.fill": "Piepildīt",
    "paint.paintEditor.costume": "Tērps",
    "paint.paintEditor.group": "Grupa",
    "paint.paintEditor.ungroup": "Izjaukt grupu",
    "paint.paintEditor.undo": "Atsaukt",
    "paint.paintEditor.redo": "Pārtaisīt",
    "paint.paintEditor.forward": "Uz priekšu",
    "paint.paintEditor.backward": "Atpakaļ",
    "paint.paintEditor.front": "Priekšpuse",
    "paint.paintEditor.back": "Atpakaļ",
    ...
    "paint.modeTools.pointed": "Centrēts",
    ...
    "paint.modeTools.filled": "Pildīts",
    "paint.modeTools.outlined": "Riņķa līnija",
    ...
    "paint.eraserMode.eraser": "Džēšgumija",
    "paint.fillMode.fill": "Piepildīt",
    ...
    "paint.selectMode.select": "Izvēlēties",
  ...
  "lt": {
    ...
    "paint.paintEditor.forward": "Persiųsti",
    "paint.paintEditor.backward": "Į galą",
    ...
    "paint.modeTools.curved": "Kreivinti",
    "paint.modeTools.pointed": "Punktyrinė",
  ...
  "ja-Hira": {
    ...
    "paint.textMode.text": "テキスト",
    "paint.colorPicker.swap": "こうかん"
  },
  "hu": {
    "paint.paintEditor.hue": "Szín",
    "paint.paintEditor.saturation": "Színtelítettség",
    ...
    "paint.paintEditor.group": "Csoport",
    "paint.paintEditor.ungroup": "Csoport bontás",
    "paint.paintEditor.undo": "Visszavonás",
    "paint.paintEditor.redo": "Mégis",
    "paint.paintEditor.forward": "Előre",
    "paint.paintEditor.backward": "Hátraküld",
    "paint.paintEditor.front": "Előtér",
    "paint.paintEditor.back": "Vissza",
    ...
    "paint.modeTools.pointed": "Jelölt",
    ...
    "paint.modeTools.outlined": "Körvonal",
    ...
    "paint.reshapeMode.reshape": "Átformálás",
  ...
  "ro": {
    ...
    "paint.selectMode.select": "Selecteaza",
    "paint.textMode.text": "Text",
  ...
  "sr": {
    ...
    "paint.textMode.text": "Текст",
    "paint.colorPicker.swap": "Узајамно замени"
  },
  "sk": {
    "paint.paintEditor.hue": "Farba",
    "paint.paintEditor.saturation": "Sýtosť",
    "paint.paintEditor.brightness": "Svetelnosť",
    "gui.comingSoon.message1": "Na tomto ešte pracujeme {emoji}",
    "gui.comingSoon.message2": "Čoskoro to bude hotové...",
    "gui.comingSoon.message3": "Na tomto ešte pracujeme {emoji}",
    "paint.paintEditor.fill": "Výplň",
    "paint.paintEditor.costume": "Kostým",
    "paint.paintEditor.group": "Zoskupiť",
    "paint.paintEditor.ungroup": "Rozdeliť skupinu",
    "paint.paintEditor.undo": "Naspäť",
    "paint.paintEditor.redo": "Znova",
    "paint.paintEditor.forward": "Do popredia",
    "paint.paintEditor.backward": "Do pozadia",
    ...
    "paint.modeTools.copy": "Kopírovať",
    "paint.modeTools.paste": "Vložiť",
    "paint.modeTools.delete": "Zmazať",
    "paint.modeTools.curved": "Na krivky",
    "paint.modeTools.pointed": "Na body",
    "paint.modeTools.thickness": "Hrúbka",
    "paint.modeTools.flipHorizontal": "Zrkadliť vodorovne",
    "paint.modeTools.flipVertical": "Zrkadliť zvisle",
    "paint.modeTools.filled": "Vyplnené",
    "paint.modeTools.outlined": "Obrys",
    "paint.paintEditor.bitmap": "Zmeniť na raster",
    "paint.paintEditor.vector": "Zmeniť na vektory",
    "paint.paintEditor.stroke": "Obrys",
    ...
    "paint.lineMode.line": "Úsečka",
    "paint.ovalMode.oval": "Kružnica",
    "paint.rectMode.rect": "Obdĺžnik",
    "paint.reshapeMode.reshape": "Upraviť tvar",
    "paint.roundedRectMode.roundedRect": "Zaoblený obdĺžnik",
    "paint.selectMode.select": "Označiť",
    "paint.textMode.text": "Text",
    "paint.colorPicker.swap": "Vymeniť farby"
  },
  "sl": {
    "paint.paintEditor.hue": "Barva",
  ...
  "tr": {
    ...
    "paint.paintEditor.stroke": "Taslak",
    "paint.brushMode.brush": "Fırça",
